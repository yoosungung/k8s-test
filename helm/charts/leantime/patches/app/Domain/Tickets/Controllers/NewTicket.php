...
/**
 * k8s-test patch: post() validation-failure path must assign ticketParents
 * (same as get()) so tickets.newTicketModal / ticketDetails re-render does not 500.
 */
class NewTicket extends Controller
{
    ...
    private function assignTicketForm(TicketModel $ticket): void
    {
